"""Dormant Solo Block 2 public-root V4 activation-construction package.
...
SCHEMA_VERSION: Final = "heterodiff-solo-block2-runtime-custody-executor-v4"
MACHINE_SCHEMA: Final = (
    "heterodiff-manuscript-v3-solo-block2-runtime-custody-closure-v4"
)
MACHINE_STATE: Final = (
    "FINAL_V4_OFFLINE_ACTIVATION_CONSTRUCTION_EMPTY_ROOT_RECEIPTS_NULL_NETWORK_HOLD"
)
PACKAGE_LOCK_SCHEMA: Final = "heterodiff-solo-block2-runtime-package-lock-v4"
PREFLIGHT_AUTHORITY_SCHEMA: Final = (
    "heterodiff-solo-block2-runtime-preflight-authority-v4"
)
RUNTIME_PREFLIGHT_SCHEMA: Final = "heterodiff-solo-block2-runtime-preflight-v4"
INDEPENDENT_GO_SCHEMA: Final = "heterodiff-solo-block2-root-row-independent-go-v4"
ROW_AUTHORITY_SCHEMA: Final = "heterodiff-solo-block2-root-row-authority-v4"
INTENT_SCHEMA: Final = "heterodiff-solo-block2-root-row-intent-v4"
OUTCOME_SCHEMA: Final = "heterodiff-solo-block2-root-row-outcome-v4"
ERROR_SCHEMA: Final = "heterodiff-solo-block2-root-row-error-v4"

# This source retains the reviewed future protocol below, but the current V4
# package has no activation authority and no authorized successor attempt.
# Every production surface checks this immutable construction boundary before
# inspecting a caller-supplied root or reaching any filesystem/process/network
# action.
ACTIVATION_AUTHORITY_PRESENT: Final = False
FETCH_ELIGIBLE: Final = False
AUTHORIZED_SUCCESSOR_ATTEMPT_BUDGET: Final = 0
PLANNED_GLOBAL_SUCCESSOR_ATTEMPT_LIMIT: Final = 1
SUCCESSOR_BUDGET_SCOPE: Final = "GLOBAL_SINGLE_ADDITIONAL_ROW0_ATTEMPT_ONLY"
SUCCESSOR_BUDGET_ID: Final = (
    "da3af347580d19b11f83b8590018a61b2e4296c613f78d8a1039c1c9cfdfb9ce"
)
V4_OPERATIONAL_ROOT: Final = (
...
V4_OPERATIONAL_ROOT_IDENTITY: Final = {
    "absolute_path": V4_OPERATIONAL_ROOT,
    "device": 16777234,
    "inode": 67067435,
    "uid": 501,
    "gid": 20,
    "mode_octal": "0700",
    "nlink_at_construction": 2,
    "empty_at_construction": True,
}
V2_SPENT_EVIDENCE: Final = {
    "intent_raw_sha256": "a02263b26109ef29f7212a8ea72c987e9e4f7732a88f6ff6b305b99d89177b92",
    "intent_record_sha256": "e3735ad4c4ab07e79ab0dbc3ef8e8f3c26f5ee86489a7233b854854dea5d1610",
    "error_raw_sha256": "705ddcdb3f0be55ad434620c574a21ea3e02aff6c892ca88f1743d5da6ec3964",
    "error_record_sha256": "aaeca81dd0bd9305c624249cfdc057387fd465fee5b889b16b81ce752285ef55",
    "outcome_raw_sha256": "ae72c77609c10c21aaf3e64a8ab77bf4da3adb03c42e55f3bfdfa17f00a98458",
    "outcome_record_sha256": "b463ba6475fe82dae08aa98ca2a7d3710915b077f97de2748edf84445aca4924",
    "terminal_state": "TERMINAL_TRANSPORT_OR_CONTENT_NO_GO_NO_RETRY",
    "attempt_budget_spent": True,
    "retry_permitted": False,
}
V3_PREDECESSOR_SHA256: Final = {
    "PROJECT_SOLO_BLOCK2_RUNTIME_CUSTODY_CLOSURE_V3.md": "7761bcf3e87dd527e6f17fe3d74783b848f886957baee3e1ca69678ed24efd60",
    "research/fixtures/manuscript_v3_solo_block2_runtime_custody_closure_v3.json": "a9b007e61a5e26f1d44a642442c305281408f2998d7dc48a7545b81c2c5d3779",
    "research/diagnostics/manuscript_v3_solo_block2_runtime_custody_closure_v3.py": "53fb7a3afb8f0cf798e9d0cd0970fe370f5e2c0a7ed72bef0ce5c9f414de1153",
    "src/heterodiff/artifacts/solo_block2_runtime_custody_executor_v3.py": "e2059b19e1bfa447370392451fdf3574145ef68618b31b2f9c9af8a21239c2a9",
    "tests/unit/test_solo_block2_runtime_custody_executor_v3.py": "50ec9de7e18d43a81d0d1164a3710165fd02f40cd43489f37754b95ca0132fdf",
    "tests/unit/test_manuscript_v3_solo_block2_runtime_custody_closure_v3.py": "07852addf23917e844ee3a7c6fcb00eed0c94255b74aa2772c78b5b6db644d18",
}
...
MACHINE_RELATIVE_PATH: Final = (
    "research/fixtures/"
    "manuscript_v3_solo_block2_runtime_custody_closure_v4.json"
)
SOURCE_RELATIVE_PATH: Final = (
    "src/heterodiff/artifacts/solo_block2_runtime_custody_executor_v4.py"
)
...
def _require_activation_authority_present() -> NoReturn:
    """Permanently stop every production surface in this construction package."""

    if (
        ACTIVATION_AUTHORITY_PRESENT is not False
        or FETCH_ELIGIBLE is not False
        or AUTHORIZED_SUCCESSOR_ATTEMPT_BUDGET != 0
    ):
        raise GateError("invalid compiled V4 construction-state constants")
    raise GateError(
        "V4 construction package is permanently dormant; a separately frozen "
        "successor activation package is required"
    )


def _require_dormant_production_row0(row: Any) -> NoReturn:
    """Reject non-row0 values, then enforce the immutable dormant boundary."""

    if type(row) is not int or row != 0:
        raise GateError("V4 successor production surface is exact integer row 0 only")
    _require_activation_authority_present()
...
def _require_machine_state(machine: Mapping[str, Any]) -> None:
    if machine.get("state") != MACHINE_STATE:
        raise GateError("machine state is not the stopped v3 candidate state")
...
def _require_machine_non_effects(machine: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        or effects.get("v3_fetch_performed") is not False
        or effects.get("v3_resolver_call_performed") is not False
        or effects.get("v3_durable_row_intent_created") is not False
        or effects.get("v3_operational_receipt_created") is not False
        or effects.get("v3_operational_root_created") is not False
        or type(slots) is not dict
        or any(value is not None for value in slots.values())
        or machine.get("operational_custody_root") is not None
    ):
        raise GateError("machine falsely reports construction-time v3 activity")
...
def _current_package_inputs(
    ...
    aggregate_payload = {
        "schema_version": "heterodiff-solo-block2-runtime-package-aggregate-v3",
...
def _render_preflight_authority(
    ...
    return "\n".join(
        [
            "AUTHORIZE_SOLO_BLOCK2_OFFLINE_RUNTIME_PREFLIGHT_V2",
...
def _validate_row0_success_for_row1(
    ...
    try:
        ...
        intent, intent_raw, _ = _read_receipt_at(
        ...
        # ``_exclusive_canonical_at`` returns the raw canonical receipt digest,
        # and outcomes bind that raw digest.  V2 accidentally compared this
        # field with the semantic self-digest instead.
        _require_raw_receipt_forward_link(
            outcome.get("intent_record_sha256"), intent_raw, "row 0 intent"
        )
        if (
...
def _render_row_authority(
    ...
    return "\n".join(
        [
            "AUTHORIZE_SOLO_BLOCK2_EXACT_ROOT_PAGE_ATTEMPT_V3",
...
def register_independent_go(
    ...
    _require_dormant_production_row0(row)
    op = _operation(row)
    machine, machine_raw, rootfd, root_st = _open_registrar_root(
...
def _usage() -> NoReturn:
    raise SystemExit(
        "usage: solo_block2_runtime_custody_executor_v4.py "
        "register-package-lock ROOT REVIEWER CREATED_UNIX_NS | "
        "register-preflight-authority ROOT CREATED_UNIX_NS EXACT_TEXT | "
        "preflight ROOT | "
        "register-independent-go ROOT 0 REVIEWER CREATED_UNIX_NS | "
        "register-row-authority ROOT 0 CREATED_UNIX_NS EXPIRES_UNIX_NS EXACT_TEXT | "
        "attempt ROOT 0"
    )
...
def main() -> int:
    ...
    try:
        ...
        elif len(args) == 3 and args[0] == "attempt" and args[2] == "0":
