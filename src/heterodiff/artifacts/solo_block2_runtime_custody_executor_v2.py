...
SCHEMA_VERSION: Final = "heterodiff-solo-block2-runtime-custody-executor-v2"
MACHINE_SCHEMA: Final = (
    "heterodiff-manuscript-v3-solo-block2-runtime-custody-closure-v2"
)
MACHINE_STATE: Final = (
    "FINAL_V2_EXECUTOR_QUALIFIED_OPERATIONAL_RECEIPTS_NULL_FETCH_HOLD"
)
PACKAGE_LOCK_SCHEMA: Final = "heterodiff-solo-block2-runtime-package-lock-v2"
PREFLIGHT_AUTHORITY_SCHEMA: Final = (
    "heterodiff-solo-block2-runtime-preflight-authority-v2"
)
RUNTIME_PREFLIGHT_SCHEMA: Final = "heterodiff-solo-block2-runtime-preflight-v2"
INDEPENDENT_GO_SCHEMA: Final = "heterodiff-solo-block2-root-row-independent-go-v2"
ROW_AUTHORITY_SCHEMA: Final = "heterodiff-solo-block2-root-row-authority-v2"
INTENT_SCHEMA: Final = "heterodiff-solo-block2-root-row-intent-v2"
OUTCOME_SCHEMA: Final = "heterodiff-solo-block2-root-row-outcome-v2"
ERROR_SCHEMA: Final = "heterodiff-solo-block2-root-row-error-v2"
...
def _require_machine_state(machine: Mapping[str, Any]) -> None:
    if machine.get("state") != MACHINE_STATE:
        raise GateError("machine state is not the stopped v2 closure state")
...
def _require_machine_non_effects(machine: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        or effects.get("v2_fetch_performed") is not False
        or effects.get("v2_resolver_call_performed") is not False
        or effects.get("v2_durable_row_intent_created") is not False
        or type(slots) is not dict
        or any(value is not None for value in slots.values())
    ):
        raise GateError("machine falsely reports construction-time v2 activity")
...
def _current_package_inputs(
    ...
    aggregate_payload = {
        "schema_version": "heterodiff-solo-block2-runtime-package-aggregate-v2",
...
def _render_row_authority(
    ...
    return "\n".join(
        [
            "AUTHORIZE_SOLO_BLOCK2_EXACT_ROOT_PAGE_ATTEMPT_V2",
...
def _usage() -> NoReturn:
    raise SystemExit(
        "usage: solo_block2_runtime_custody_executor_v2.py "
