"""Dormant Solo Block 2 public-root runtime/custody executor v3 candidate.
...
SCHEMA_VERSION: Final = "heterodiff-solo-block2-runtime-custody-executor-v3"
MACHINE_SCHEMA: Final = (
    "heterodiff-manuscript-v3-solo-block2-runtime-custody-closure-v3"
)
MACHINE_STATE: Final = (
    "FINAL_V3_ENUM_AND_ROW1_LINK_REPAIR_QUALIFIED_NO_OPERATIONAL_ROOT_NO_FETCH_HOLD"
)
PACKAGE_LOCK_SCHEMA: Final = "heterodiff-solo-block2-runtime-package-lock-v3"
PREFLIGHT_AUTHORITY_SCHEMA: Final = (
    "heterodiff-solo-block2-runtime-preflight-authority-v3"
)
RUNTIME_PREFLIGHT_SCHEMA: Final = "heterodiff-solo-block2-runtime-preflight-v3"
INDEPENDENT_GO_SCHEMA: Final = "heterodiff-solo-block2-root-row-independent-go-v3"
ROW_AUTHORITY_SCHEMA: Final = "heterodiff-solo-block2-root-row-authority-v3"
INTENT_SCHEMA: Final = "heterodiff-solo-block2-root-row-intent-v3"
OUTCOME_SCHEMA: Final = "heterodiff-solo-block2-root-row-outcome-v3"
ERROR_SCHEMA: Final = "heterodiff-solo-block2-root-row-error-v3"
...
def _usage() -> NoReturn:
    raise SystemExit(
        "usage: solo_block2_runtime_custody_executor_v3.py "
