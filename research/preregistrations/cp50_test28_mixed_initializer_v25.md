# CP50 Test-28 mixed-support initializer protocol v1 — DRAFT sidecar v25
...
This file is the additive v25 DRAFT sidecar.  Its scientific protocol
identifier remains `cp50-test28-mixed-initializer-v1`; the sidecar generation
does not create a new scientific protocol, rewrite the immutable v24 protocol
or manifest, freeze either v25 path, or authorize execution.  CP74 binds the
exact v24 bytes as predecessor-only custody and requires its four source/test
hashes and three live public record packets to be supplied by this later
manifest.  Those pins do not change v24's `DRAFT` state, constitute a freeze
receipt, accept the candidate descriptor packet for production, make either
sidecar authoritative, or make v25 an input consumed by CP74.  The proposed
v15 lifecycle graph remains nonauthoritative for production.
...
### 10.1 Completed CP52--CP74 nonconfirmatory prerequisites
...
production occurrence/output descriptor source/test evidence.  None of these
sidecars is a freeze receipt, accepted production schema, or production
authorization.  CP65 consumes v15, CP66 consumes v16, CP67 consumes v17, CP68
consumes v18, CP69 consumes v19, CP70 consumes v20, CP71 consumes v21, CP72
consumes v22, CP73 consumes v23, and CP74 consumes v24 only as predecessor
custody; none consumes v25 or makes the proposed lifecycle authoritative.  Any
byte change requires renewed testing and a new manifest binding before freeze
review.
...
The DRAFT blocker ledger now contains twenty-nine entries: twenty-five satisfied by
