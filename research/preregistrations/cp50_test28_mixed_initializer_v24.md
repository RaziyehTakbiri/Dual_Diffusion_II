# CP50 Test-28 mixed-support initializer protocol v1 — DRAFT sidecar v24
...
This file is the additive v24 DRAFT sidecar.  Its scientific protocol
identifier remains `cp50-test28-mixed-initializer-v1`; the sidecar generation
does not create a new scientific protocol, rewrite the immutable v23 protocol
or manifest, freeze either v24 path, or authorize execution.  CP73 binds the
exact v23 bytes as predecessor-only inputs and requires its own source hashes
to be supplied by this later manifest.  That hash pin does not change v23's
`DRAFT` state, constitute a freeze receipt, make either sidecar authoritative
for production, or make v24 an input consumed by CP73.  The proposed v15
...
### 10.1 Completed CP52--CP73 nonconfirmatory prerequisites
...
source/test evidence.  None of these sidecars is a freeze receipt or production
...
consumes v22, and CP73 consumes v23 only as predecessor custody; none consumes
v24 or makes the proposed lifecycle authoritative.  Any byte change
...
The DRAFT blocker ledger now contains twenty-eight entries: twenty-four satisfied by
